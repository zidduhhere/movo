...
import { PanelLeft, Plus, MessageCircle, CheckSquare2, Clock, Flag } from 'lucide-react';
                ...
                <div className={clsx('shrink-0 h-[76px] pt-4 flex items-center justify-between px-5 border-b border-black/8 bg-white/60 backdrop-blur-sm', !isSidebarOpen && 'pl-20')}>
                    ...
                    <div className="flex items-center gap-2">
                        <button
                            ...
                            className="flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-[#85D24E] hover:bg-[#7bc248] text-black text-[12px] font-semibold shadow-sm transition-colors"
                        >
                                ...
                                return (
                                    <div
                                        ...
                                        className={clsx(
                                            ...
                                            isActiveChat ? 'border-[#85D24E] ring-1 ring-[#85D24E]/30' : 'border-black/8'
                                        )}
                                    >
                                        {/* Status icon */}
                                        <div className="shrink-0">
                                            {task.status === 'completed'
                                                ? <CheckSquare2 className="w-4 h-4 text-[#85D24E]" />
                                        ...
                                        <div className="flex items-center gap-2 shrink-0">
                                            ...
                                            <button
                                                ...
                                                className={clsx(
                                                    ...
                                                    isActiveChat
                                                        ? 'bg-[#85D24E] text-black border-transparent'

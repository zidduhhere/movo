        ...
        <div className="w-full bg-white border border-[#E5E5EA] rounded-[16px] shadow-[0_8px_30px_rgba(0,0,0,0.04)] p-5 relative overflow-hidden">
            <div className="relative flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                <div className="flex gap-4">
                    <div className="shrink-0 w-12 h-12 bg-[#85D24E] rounded-full flex items-center justify-center shadow-sm">
                        <Sparkles className="w-6 h-6 text-white" />
                    </div>
                    <div className="flex flex-col justify-center">
                        <span className="text-[11px] font-semibold text-[#85D24E] uppercase tracking-wider mb-0.5">Next Best Action</span>
                ...
                <button
                    ...
                    className="shrink-0 flex items-center gap-2 bg-[#85D24E] hover:bg-[#78C245] text-[#1C1C1E] px-5 py-2.5 rounded-full text-[14px] font-medium transition-all shadow-md active:scale-95 focus:outline-none"
                >
